document.addEventListener("DOMContentLoaded", function () {
    ...
    mostrarMensagemBtn.addEventListener("click", function () {
        ...
        "Ser professor é mais que um trabalho, é uma vocação e uma verdadeira arte."
        "Quero agradecer por toda a sua dedicação e paciência."
        "Agradeço por toda a dedicação e alegria."
